...
let make = () =>
  <Slide id="defining-reason-react-components">
    <Heading size=4> (ReasonReact.stringToElement("Building Components with ")) </Heading>
    <Heading size=3> (CodeFormat.color(Theme.red, "ReasonReact")) </Heading>
    <br />
    <List_ textSize="35px">
      <Appear>
        <ListItem> (ReasonReact.stringToElement("Create the component template.")) </ListItem>
      </Appear>
      <Appear>
        <ListItem>
          (ReasonReact.stringToElement("Define a "))
          <code> (ReasonReact.stringToElement("make")) </code>
      ...
      <Appear>
        <ListItem>
          ...
          <code> (ReasonReact.stringToElement("render")) </code>
