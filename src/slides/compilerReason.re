let component = ReasonReact.statelessComponent "ReasonCompilerSteps";

let steps = [|"Source Code", "ReasonML", "Typed AST", "Lambda IR", "Bytecode"|];
